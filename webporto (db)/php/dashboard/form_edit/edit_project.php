            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="white-box">
                            <div class="user-bg" style="height: 260px;">
                                ...
                                ?>
                                <div class="card" style="width: 22rem; height: 260px;">
                                    <img class="card-img-top" src="<?php echo $row["gambar"];?>" height="150px">
                                    <div class="card-body">
                                        <h5 class="card-title" style="text-transform: capitalize;"><?php echo $row["judul"];?></h5>
                                        <p class="card-text" style="text-transform: capitalize;"><?php echo $row["deskripsi"];?></p>
                                    </div>
                                </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        ...
                        <div class="card">
                            ...
                            ?>
                                <form class="form-horizontal form-material" action="simpan2.php" method="POST">
                                    <div class="form-group mb-4">
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="hidden" class="form-control p-0 border-0" name="id" value="<?php echo $row["id"];?>"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Judul:</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Masukan Judul"
                                                class="form-control p-0 border-0" name="judul" value="<?php echo $row["judul"];?>"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Gambar:</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Masukan Link"
                                                class="form-control p-0 border-0" name="gambar" value="<?php echo $row["gambar"];?>"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Deskripsi:</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Masukan Deskripsi"
                                                class="form-control p-0 border-0"  name="desk" value="<?php echo $row["deskripsi"];?>">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
