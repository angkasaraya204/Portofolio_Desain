                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        ...
                        <div class="card">
                            ...
                            ?>
                                <form class="form-horizontal form-material" action="simpan.php" method="POST">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Masukan Nama"
                                                class="form-control p-0 border-0" name="user" value="<?php echo $row["username"];?>"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Nama Lengkap:</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Masukan Nama"
                                                class="form-control p-0 border-0" name="lngkp" value="<?php echo $row["namalngkp"];?>"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="email" placeholder="Masukan Email"
                                                ...
                                                id="example-email" name="emailadd" value="<?php echo $row["emailadd"];?>">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Password</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="password" name="sandi" class="form-control p-0 border-0" placeholder="Masukan Password" value="<?php echo md5($row["katasandi"]);?>">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Gambar</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="gambar" class="form-control p-0 border-0" placeholder="Masukan Password" value="<?php echo $row["gambar"];?>">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Quotes:</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="quotes" class="form-control p-0 border-0" placeholder="Masukan Password" value="<?php echo $row["quotes"];?>">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
